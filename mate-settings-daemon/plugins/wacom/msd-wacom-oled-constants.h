...
#ifndef __MSD_WACOM_OLED_CONSTANTS_H
#define __MSD_WACOM_OLED_CONSTANTS_H

G_BEGIN_DECLS

typedef enum {
	MSD_WACOM_OLED_TYPE_USB,
	MSD_WACOM_OLED_TYPE_BLUETOOTH,
	MSD_WACOM_OLED_TYPE_RAW_BLUETOOTH
} MsdWacomOledType;
...
#endif /* __MSD_WACOM_OLED_CONSTANTS_H */
