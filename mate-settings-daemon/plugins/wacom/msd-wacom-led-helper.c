...
static int
msd_wacom_led_helper_write (const gchar *filename, gint value, GError **error)
{
	gchar *text = NULL;
	gint retval;
	gint length;
...
int main (int argc, char **argv)
{
	...
	g_option_context_set_summary (context, "MATE Settings Daemon Wacom LED Helper");
	...
	if (msd_wacom_led_helper_write (filename, value, &error)) {
