 ...
 * mate-control-center has been used, and we load up an
...
show_button_mapping_dialog (CcWacomPage *page)
{
	...
	gtk_builder_add_from_resource (priv->mapping_builder,
                                       "/org/mate/control-center/wacom/button-mapping.ui",
                                       &error);
...
cc_wacom_page_init (CcWacomPage *self)
{
	...
	gtk_builder_add_objects_from_resource (priv->builder,
                                               "/org/mate/control-center/wacom/mate-wacom-properties.ui",
                                               objects,
                                               &error);
	if (error != NULL) {
		g_warning ("Error loading UI file: %s", error->message);
	       ...
	       const char  *icon_name)
{
	...
	resource = g_strdup_printf ("/org/mate/control-center/wacom/%s.svg", icon_name);
